...
install -m 0644 "${ARTIFACT_DIR}/MANIFEST.sha256" "${PROVENANCE_DIR}/dist-MANIFEST.sha256"
install -m 0644 "${ARTIFACT_DIR}/MANIFEST.sha256.sha256" "${PROVENANCE_DIR}/dist-MANIFEST.sha256.sha256"
