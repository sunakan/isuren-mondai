...
func main() {
	...
	flags.StringVar(&conf.TargetURLStr, "target-url", "http://isucon9.isuren.internal", "target url")
	flags.StringVar(&conf.TargetHost, "target-host", "isucon9.isuren.internal", "target host")
